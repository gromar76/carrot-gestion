...
function editar() {
  ...
  // guardo en id el valor del atributo data-id del boton que pulse, eso es el id de la provincia
  const id = $(this).attr("data-id");
  window.location = `${URL_BASE}/index.php?m=provincias&a=editar&id=${id}`;
