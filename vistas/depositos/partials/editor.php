...
// este archivo debe manejar el AGREGAR,VER Y EDITAR ----> Categorias
...
<div class="row d-flex justify-content-center">
    <form method="post" action="index.php?m=depositos&a=<?= isset($data["registros"]["id"]) ? "editar&id=" . $data['registros']['id'] : "agregar" ?>"
        class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">

        <div class="form-group row"> 
            <label for="nombre" class="col-3 col-form-label">Nombre</label> 
            <div class="col-9">
            <input id="nombre" name="nombre" data-id-original="<?=$idDeposito?>" type="text" class="form-control" <?=$disabled?>  value="<?=$nombre?>">
            </div>
        </div>     
        <div class="form-group row">
