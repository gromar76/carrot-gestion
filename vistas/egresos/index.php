<?php
    ...
    switch($accion){
        case "listado":
            $data["contenido"] =  'vistas/egresos/partials/listado.php';
            $data["titulo"] = "Listado de Egresos";
            break;

        case "editar":
            $data["contenido"] =  'vistas/egresos/partials/editor.php';
            $data["titulo"] = "Editando el Egreso";                       
            break;
        
        case "agregar":
            $data["contenido"] =  'vistas/egresos/partials/editor.php';
            $data["titulo"] = "Agregando el Egreso";            
            break;

              
        case "eliminar":
            $data["contenido"] =  'vistas/egresos/partials/listado.php';
            $data["titulo"] = "Eliminando Egreso";
            break;

         case "ver":
            // agarro el contenido y luego lo muestro en vistas/base/index.php
            $data["contenido"] =  'vistas/egresos/partials/editor.php';
            $data["titulo"] = "Viendo detalle de Egreso";
            break;
